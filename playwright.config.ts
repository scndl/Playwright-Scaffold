...
export default defineConfig({
    ...
    projects: [
       ...
       //     use: {
       //         ...devices['Desktop Chrome'],
        //        // storageState: '.auth/app/appStorageState.json', // Disabled for DemoWebShop tests
         //       viewport: { width: 1366, height: 768 },
        //    },
            // dependencies: ['setup'], // Temporarily disabled for demowebshop tests
            // testIgnore: '**/demowebshop/**', // Temporarily enabled
       // },

        /* DemoWebShop project - independent of setup */
        {
            name: 'demowebshop',
            use: {
                ...devices['Desktop Chrome'],
